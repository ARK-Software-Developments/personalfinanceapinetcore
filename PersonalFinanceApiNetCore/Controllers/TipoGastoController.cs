namespace PersonalFinanceApiNetCore.Controllers
{
    ...
    {
        private readonly ILogger<TipoGastoController> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="TipoGastoController"/> class.
        /// </summary>
        /// <param name="logger">ILogger.</param>
        public TipoGastoController(ILogger<TipoGastoController> logger)
        {
            _logger = logger;
        }
        ...
        {
            List<TipoGasto> entidades = new TipoGastoBL().GetAll();
        ...
        {
            List<TipoGasto> entidades = new TipoGastoBL().GetId(id);
        ...
        {
           long entidades = new TipoGastoBL().AddUpdateEntity("create", parametros);
        ...
        {
            long entidades = new TipoGastoBL().AddUpdateEntity("update", parametros);
