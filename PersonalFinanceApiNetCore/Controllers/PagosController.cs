...
#pragma warning disable SA1009
    ...
    {
        private readonly ILogger<PagosController> _logger = logger;
        ...
        {
            List<Pago> entidades = new PagosBL().GetAll();
        ...
        {
            List<Pago> entidades = new PagosBL().GetId(id);
        ...
        {
           var entidades = new PagosBL().AddUpdateEntity("create", parametros);
        ...
        {
            var entidades = new PagosBL().AddUpdateEntity("update", parametros);
