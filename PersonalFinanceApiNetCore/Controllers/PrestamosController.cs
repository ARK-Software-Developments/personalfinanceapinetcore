...
#pragma warning disable SA1009
    ...
    {
        private readonly ILogger<PrestamosController> _logger = logger;
        ...
        {
            List<Prestamo> entidades = new PrestamosBL().GetAll();
        ...
        {
            List<Prestamo> entidades = new PrestamosBL().GetId(id);
        ...
        {
           var entidades = new PrestamosBL().AddUpdateEntity("create", parametros);
        ...
        {
            var entidades = new PrestamosBL().AddUpdateEntity("update", parametros);
